...
def get_version(*file_paths):
    """Retrieves the version from starboard/__init__.py"""
...
version = get_version("starboard", "__init__.py")
...
setup(
    ...
    url='https://github.com/yothinix/dj-starboard',
    packages=[
        'starboard',
    ],
